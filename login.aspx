...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body id="login">
		...
		<div id="login-wrapper" class="png_bg">
			<div id="login-top">
				<img src="images/bio-natural.png" alt="BIO * NATURAL" title="BIO * NATURAL" />			
			</div>
			...
			<div id="login-content">
					...
					<p>
						<label>Usuario</label>
						<input value="" name="username" id="txtusuario" runat="server" class="text-input" type="text" />
					</p>
					<br style="clear: both;" />
					<p>
						<label>Contrasena</label>
						<input name="password" id="txtpassword" runat="server" class="text-input" type="password" />
					</p>
					<br style="clear: both;" />

                    <p><label id="resultado" runat="server"></label> </p>
                    <br style="clear: both;" />

					<p>
						<asp:Button ID="Button1" class="button" Text="Conectar" runat="server"/>
					</p>
