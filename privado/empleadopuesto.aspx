<%@ Page Language="VB" AutoEventWireup="false" CodeFile="empleadopuesto.aspx.vb" Inherits="privado_empleadopuesto" %>
...
//FUNCION UTILIZADA PARA OCULTAR BOTON ACTUALIZAR,ELIMINAR,CANCELAR Y PARA MOSTRAR EL BOTON GUARDAR, LIMPIAR FORMULARIO Y FOCO A UN TEXTO
	        ...
	        $('#btnbuscar').click(function () {
	            ...
	            $.ajax({
	                type: "POST",
	                url: "../WSPuesto.asmx/PuestoBuscar",
	        ...
	        $('#btnguardar').click(function () {
	            ...
	            if (!nombre)
	                ...
	                $.ajax({
	                    type: "POST",
	                    url: "../WSPuesto.asmx/PuestoGuardar",
	                    data: '{nombre: "' + nombre + '"}',
	                    contentType: "application/json; charset=utf-8",
	                    dataType: "json",
	                    success: guardarsi,
	        ...
	        $('#btnactualizar').click(function () {
	            ...
	            $.ajax({
	                type: "POST",
	                url: "../WSPuesto.asmx/PuestoActualizar",
          ...
          function(returnvalue) { 
            if(returnvalue)
            {
	            ...
	            $.ajax({
	                type: "POST",
	                url: "../WSPuesto.asmx/PuestoEliminar",
	                data: '{idpuesto: "' + idpuesto + '"}',
	                contentType: "application/json; charset=utf-8",
	                dataType: "json",
	                success: eliminasi,
	        ...
	        function eliminano(msg) {
	            $.each(msg.d, function () {
	                Sexy.error("<h1>Control Medico Web</h1><p>" + this.mensaje + "</p>");
	            });
	        }
...
<form id="formulario" >
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle">
            ...
            <li class="icn_folder"><a href="#" style="color:#04B404;text-shadow: 1px 1px white; font-weight:bolder;" >Cargos</a></li>
...
<!--			<li class="icn_view_users"><a href="usuarioperfil.aspx">Perfiles</a></li>
	...
	<section id="main" class="column">
		...
		<article class="module width_full">
			<header><h3>DATOS PUESTO</h3></header>
