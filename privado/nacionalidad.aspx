<%@ Page Language="VB" AutoEventWireup="false" CodeFile="nacionalidad.aspx.vb" Inherits="privado_nacionalidad" %>
...
//FUNCION UTILIZADA PARA OCULTAR BOTON ACTUALIZAR,ELIMINAR,CANCELAR Y PARA MOSTRAR EL BOTON GUARDAR, LIMPIAR FORMULARIO Y FOCO A UN TEXTO
	        ...
	        function datossi(msg) {
	            $("#dropbusqueda").html("");
	            $.each(msg.d, function () {
	                $("#dropbusqueda").append($("<option></option>").attr("value", this.idpuesto).text(this.nombre))
	            });
	        }
	        ...
	        //FUNCION PARA MOSTRAR LAS UsuarioS EN EL DROP DOWN
	        $(document).ready(function () {
	            ...
	            $('#btnbuscar').click(function () {
	                var idpuesto = document.getElementById('dropbusqueda').value;

	                $.ajax({
	                    type: "POST",
	                    url: "../WSPuesto.asmx/NacionalidadBuscar",
	            ...
	            $('#btnguardar').click(function () {
	                ...
	                var mensaje = "Ingrese la nacionalidad";
	                if (!nombre)
	                    Sexy.error("<h1>Control Medico Web</h1><br/><p>" + mensaje + "</p>");
	                else {
	                    $.ajax({
	                        type: "POST",
	                        url: "../WSPuesto.asmx/NacionalidadGuardar",
	                        data: '{nombre: "' + nombre + '"}',
	                        contentType: "application/json; charset=utf-8",
	                        dataType: "json",
	                        success: guardarsi,
	            ...
	            //BOTON ACTUALIZAR LA PUESTO SELECCIONADA
	            $('#btnactualizar').click(function () {
	                ...
	                $.ajax({
	                    type: "POST",
	                    url: "../WSPuesto.asmx/NacionalidadActualizar",
	                    data: '{idpuesto: "' + idpuesto + '", nombre: "' + nombre + '"}',
	                    contentType: "application/json; charset=utf-8",
	                    dataType: "json",
	                    success: actualizasi,
	                    error: actualizano
	            ...
	            //BOTON ELIMINAR EL PUESTO SELECCIONADO
          ...
          function (returnvalue) {
              if (returnvalue) {
                  ...
                  $.ajax({
                      type: "POST",
                      url: "../WSPuesto.asmx/NacionalidadEliminar",
                      data: '{idpuesto: "' + idpuesto + '"}',
                      contentType: "application/json; charset=utf-8",
                      dataType: "json",
                      success: eliminasi,
...
<form id="formulario" >
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle">
            ...
            <li class="icn_folder"><a href="#" style="color:#04B404;text-shadow: 1px 1px white; font-weight:bolder;">Nacionalidades</a></li>
...
<!--			<li class="icn_view_users"><a href="usuarioperfil.aspx">Perfiles</a></li>
	...
	<section id="main" class="column">
		...
		<article class="module width_full">
			<header><h3>DATOS Nacionalidad</h3></header>
