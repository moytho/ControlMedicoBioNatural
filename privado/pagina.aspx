<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pagina.aspx.vb" Inherits="privado_fotos_pagina" %>
...
<head>
	<meta charset="utf-8"/>
    <meta http-equiv"rerfresh" content="2"/>
	...
	<script type="text/javascript">
	    ...
	    $(document).ready(function () {
	        ...
	        //FUNCION PARA MOSTRAR PAGINAS EN EL DROP DOWN
	        $(document).ready(function () {
	            $.ajax({
	                type: "POST",
	                url: "../WSPagina.asmx/PaginaDatos",
	                data: "{}",
	        ...
	        function datossi(msg) {
	            $("#dropbusqueda").html("");
	            $.each(msg.d, function () {
	                $("#dropbusqueda").append($("<option></option>").attr("value", this.idpagina).text(this.nombre))
	            });
	        }
	        ...
	        $('#btnbuscar').click(function () {
	            var idpagina = document.getElementById('dropbusqueda').value;
	            //alert("hola");
	            $.ajax({
	                type: "POST",
	                url: "../WSPagina.asmx/PaginaBuscar",
	        ...
	        //BOTON GUARDAR PAGINA
	        $('#btnguardar').click(function () {
	            var nombre = document.getElementById('txtnombre').value;
	            //alert("hola");

	            if (!nombre)
	                Sexy.error("<h1>Control Medico Web</h1><br/><p> Ingrese el nombre de la pagina </p>");
	            else {
	                $.ajax({
	                    type: "POST",
	                    url: "../WSPagina.asmx/PaginaGuardar",
	                    data: '{nombre: "' + nombre + '"}',
	                    contentType: "application/json; charset=utf-8",
	                    dataType: "json",
	                    success: guardarsi,
	        ...
	        $('#btneliminar').click(function () {
             ...
             function (returnvalue) {
                 if (returnvalue) {
                     ...
                     $.ajax({
                         type: "POST",
                         url: "../WSPagina.asmx/PaginaEliminar",
                         data: '{idpagina: "' + idpagina + '"}',
                         contentType: "application/json; charset=utf-8",
                         dataType: "json",
                         success: eliminasi,
	        ...
	        $('#btnactualizar').click(function () {
	            ...
	            $.ajax({
	                type: "POST",
	                url: "../WSPagina.asmx/PaginaActualizar",
	                data: '{nombre: "' + nombre + '", idpagina: "' + idpagina + '"}',
	                contentType: "application/json; charset=utf-8",
	                dataType: "json",
	                success: actualizasi,
	                error: actualizano
...
<form id="formulario" runat="server">
	...
	<section id="main" class="column">
		...
		<article class="module width_full">
			<header><h3>Paginas del Sistema</h3></header>
