<%@ Page Language="VB" AutoEventWireup="false" CodeFile="profesion.aspx.vb" Inherits="privado_profesion" %>
...
//FUNCION UTILIZADA PARA OCULTAR BOTON ACTUALIZAR,ELIMINAR,CANCELAR Y PARA MOSTRAR EL BOTON GUARDAR, LIMPIAR FORMULARIO Y FOCO A UN TEXTO
           ...
           function cargarDatos() {
	            $.ajax({
	                type: "POST",
	                url: "../WSPuesto.asmx/ProfesionDatos",
	                data: "{}",
	        ...
	        $('#btnbuscar').click(function () {
	            ...
	            $.ajax({
	                type: "POST",
	                url: "../WSPuesto.asmx/ProfesionBuscar",
	        ...
	        $('#btnguardar').click(function () {
	            ...
	            if (!nombre)
	                ...
	                $.ajax({
	                    type: "POST",
	                    url: "../WSPuesto.asmx/ProfesionGuardar",
	                    data: '{nombre: "' + nombre + '"}',
	                    contentType: "application/json; charset=utf-8",
	                    dataType: "json",
	                    success: guardarsi,
	        ...
	        $('#btnactualizar').click(function () {
	            ...
	            $.ajax({
	                type: "POST",
	                url: "../WSPuesto.asmx/ProfesionActualizar",
          ...
          function(returnvalue) { 
            if(returnvalue)
            {
	            ...
	            $.ajax({
	                type: "POST",
	                url: "../WSPuesto.asmx/ProfesionEliminar",
	                data: '{idpuesto: "' + idpuesto + '"}',
	                contentType: "application/json; charset=utf-8",
	                dataType: "json",
	                success: eliminasi,
...
<!--			<li class="icn_view_users"><a href="usuarioperfil.aspx">Perfiles</a></li>
	...
	<section id="main" class="column">
		...
		<article class="module width_full">
			<header><h3>DATOS Profesion</h3></header>
